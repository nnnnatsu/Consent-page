...
# JavaScript to enable/disable next button based on consent checkbox
consent_script = """
<script>
    function toggleConsent(checkbox) {
        var consentButton = document.getElementById('nextButton');
...
if st.session_state['consent_accepted']:
    st.button('Next', key='nextButton', on_click=lambda: st.experimental_rerun())
